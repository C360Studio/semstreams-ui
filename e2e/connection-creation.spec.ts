...
test.describe('Connection Creation', () => {
	 ...
	 */
	test.skip('should display auto-discovered connection between matching NATS patterns', async ({ page }) => {
		...
		console.log('[TEST] nats_output port exists:', await natsOutputPort.count());
		console.log('[TEST] mavlink_input port exists:', await mavlinkInputPort.count());
