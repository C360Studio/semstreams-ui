...
### Reviewer Agent Attack Tests (Locked)
...
### Builder Agent Tests (Unlocked)

```typescript
// E2E tests owned by Builder Agent.
// Can be modified as implementation evolves.
```
